...
<body>
    @include('certificates.partials._header', ['title' => 'Landlord Gas Safety Record', 'certNo' => $certNo ?? ''])
    
    <div style="font-size:8pt;margin-bottom:5mm">
        <strong>Gas Safety (Installation and Use) Regulations 1998 section 26</strong>
    </div>
        ...
        <tr>
            <td style="width:50%;vertical-align:top;padding-right:5mm">
                ...
                <table style="width:100%;border-collapse:collapse;font-size:7pt">
                    <tr><td style="border:1px solid #999;padding:2mm"><input type="checkbox" style="margin:0"> Pipework soundness</td></tr>
                    <tr><td style="border:1px solid #999;padding:2mm"><input type="checkbox" style="margin:0"> Burner condition</td></tr>
                    <tr><td style="border:1px solid #999;padding:2mm"><input type="checkbox" style="margin:0"> Gas controls</td></tr>
                    <tr><td style="border:1px solid #999;padding:2mm"><input type="checkbox" style="margin:0"> Flue integrity</td></tr>
                    <tr><td style="border:1px solid #999;padding:2mm"><input type="checkbox" style="margin:0"> Ventilation adequate</td></tr>
                </table>
            </td>
            <td style="width:50%;vertical-align:top;padding-left:5mm">
                ...
                <div style="border:1px solid #999;padding:3mm;height:30mm;font-size:7pt">{{ $comments ?? '' }}</div>
            </td>
        </tr>
    </table>
